...
TEST_CASE("get_remote") {
  ...
  CHECK("origin" == get_remote(e, test_repo, "git@github.com:oof/oof.git"));
  CHECK("remoteE" == get_remote(e, test_repo, "git@github.com:zab/zab.git"));
  CHECK("origin" == get_remote(e, test_repo, "read-only"));
